...
# Change to the speech sample directory for all operations
$sampleDir = Join-Path $PSScriptRoot 'samples\speech'
...
# 3. Run the app
Write-Host "[INFO] Starting Live Captions app..." -ForegroundColor Cyan
python $app
