...
- **modified_at**: 2025-08-09 14:20:54.204499+02:00
- **template**: 
{{- $lastUserIdx := -1 -}}
...
FROM C:\Software\Ollama\models\blobs\sha256-3e4cb14174460404e7a233e531675303b2fbf7749c02f91864fe311ab6344e4f
TEMPLATE """
{{- $lastUserIdx := -1 -}}
{{- range $idx, $msg := .Messages -}}
{{- if eq $msg.Role "user" }}{{ $lastUserIdx = $idx }}{{ end -}}
